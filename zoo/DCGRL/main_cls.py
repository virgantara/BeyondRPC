...
from zoo.DCGRL.util.data_util import ModelNet40
from zoo.DCGRL.model.DCGRL_cls import DCGRL
import numpy as np
from torch.utils.data import DataLoader
from zoo.DCGRL.util.util import cal_loss, IOStream
import sklearn.metrics as metrics
from datetime import datetime
import zoo.DCGRL.provider
...
def _init_():
    ...
    if not args.eval:
        ...
        os.system('cp model/DCGRL_cls.py checkpoints' + '/' + args.exp_name + '/' + 'DCGRL_cls.py.backup')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type=str, default='exp_AdaDCGRL', metavar='N',

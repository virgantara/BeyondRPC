...
import os
import json
from zoo.DCGRL.PointWOLF import PointWOLF


def load_data(partition):
    all_data = []
    all_label = []
    for h5_name in glob.glob('/home/virgantara/PythonProjects/DualGraphPoint/data/modelnet40_ply_hdf5_2048/ply_data_%s*.h5' % partition):
        f = h5py.File(h5_name)
